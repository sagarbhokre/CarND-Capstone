...
def count_train_val_frames(split):
    """
    """
    import glob
...
def train_alxnet(cfg,split='z1'):
    ...
    if USE_PARTIAL_LOADING:
        init_weightfile = 'models/ts_alx_z1.h5' 
    ...
    model_filename = 'ts_alxnet_'+split+'.h5'
    logfilename = keras_utils.get_logger_filename('log_alx_'+split)
    ...
    N_train, N_val = count_train_val_frames(split)
...
def test_alxnet():
    ...
    #net.compile(optimizer='sgd',loss='mse')
    net.load_weights('ts_alxnet_z1.h5')
...
if __name__=='__main__':
    ...
    cfg = keras_utils.load_config_file('ts_alx_config.yaml')
